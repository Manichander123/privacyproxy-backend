...
class AuditLogService:
    ...
    def get_timeline(self, hours: int = 24) -> List[Dict[str, Any]]:
        ...
        # Round down 'now' to the nearest hour for the last bucket
        ...
        current = start_time
        # Create 'hours' number of buckets
        ...
        for ts, ev in recent:
            ...
            # Filter out events outside the window
            ...
            if bucket_key in buckets:
                # Count ALL events, not just redactions, or specific logic as requested
                # The user prompt example showed simple counts. 
                # Let's count *audit actions* (redaction, audit, chat) to show interactions.
